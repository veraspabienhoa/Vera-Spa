...
export default function EmployeePage({ user }) {
  ...
  return (
    <div className="staff-page">
      <div data-ui-key="u-fd8d0a52fcec" className="page-heading-row staff-heading">
        <div>
        ...
        {loading ? <div className="empty-cell"><LoaderCircle className="spin" /> Đang tải danh sách…</div> : <>
          <div className="staff-desktop-table table-wrap">
            <table data-ui-key="u-4393b63484c6" className="staff-table">
              ...
              <thead><tr><th data-ui-key="u-808b88b81319" data-ui-label-default="Chọn"><UiCustomText uiKey="u-808b88b81319">Chọn</UiCustomText></th><th data-ui-key="u-851d212f70a4" data-ui-label-default="Nhân viên"><UiCustomText uiKey="u-851d212f70a4">Nhân viên</UiCustomText></th><th data-ui-key="u-73787c141ced" data-ui-label-default="Phân quyền"><UiCustomText uiKey="u-73787c141ced">Phân quyền</UiCustomText></th><th data-ui-key="u-8bbc0cf26349" data-ui-label-default="Trạng thái"><UiCustomText uiKey="u-8bbc0cf26349">Trạng thái</UiCustomText></th><th data-ui-key="u-696353d5dcfe" data-ui-label-default="Ca làm việc"><UiCustomText uiKey="u-696353d5dcfe">Ca làm việc</UiCustomText></th><th data-ui-key="u-81f1f9cfdfdb" data-ui-label-default="Ngày bắt đầu ca"><UiCustomText uiKey="u-81f1f9cfdfdb">Ngày bắt đầu ca</UiCustomText></th><th data-ui-key="u-8b7ce93309d1" data-ui-label-default="Chu kỳ"><UiCustomText uiKey="u-8b7ce93309d1">Chu kỳ</UiCustomText></th><th data-ui-key="u-6f8b2b97fe63" data-ui-label-default="Hồ sơ"><UiCustomText uiKey="u-6f8b2b97fe63">Hồ sơ</UiCustomText></th><th data-ui-key="u-da76716af198" data-ui-label-default="Khóa"><UiCustomText uiKey="u-da76716af198">Khóa</UiCustomText></th><th data-ui-key="u-9551460a137e" data-ui-label-default="Miễn đủ hồ sơ"><UiCustomText uiKey="u-9551460a137e">Miễn đủ hồ sơ</UiCustomText></th><th data-ui-key="u-984e2cb69a74" data-ui-label-default="Không tính lương"><UiCustomText uiKey="u-984e2cb69a74">Không tính lương</UiCustomText></th><th data-ui-key="u-29063ae03680" data-ui-label-default="Admin"><UiCustomText uiKey="u-29063ae03680">Admin</UiCustomText></th></tr></thead>
              <tbody>{visible.map((employee) => {
                ...
                return <tr key={employee.username} className={rowClassName} title={missingFields.length ? `Hồ sơ còn thiếu: ${missingFields.join(', ')}` : undefined}>
                  ...
                  <td><button data-ui-key="u-6aee37a71d28" data-ui-label-default="Sửa" className="text-button staff-edit-button" disabled={!editable || !permissions.employee_edit_save} onClick={() => openProfile(employee)}><FilePenLine size={15} /><UiCustomText uiKey="u-6aee37a71d28"> Sửa</UiCustomText></button></td>
                  ...
                  <td><UiToolbar data-ui-key="u-ff76dc7be9fa" className="list-actions">{isAdmin && permissions.employees_visibility_manage && <button data-ui-key="u-9e7038c7eeef" className="secondary-button compact" disabled={Boolean(busy)} onClick={() => setEmployeeHidden(employee, !employee.profile_hidden)}>{employee.profile_hidden ? <Eye size={14}/> : <EyeOff size={14}/>} {employee.profile_hidden ? 'Hiện' : 'Ẩn'}</button>}{isAdmin && permissions.employee_delete && <button data-ui-key="u-cde4ba9d77f6" data-ui-label-default="Xóa" className="danger-button compact" disabled={Boolean(busy)} onClick={() => deleteOne(employee)}><Trash2 size={14} /><UiCustomText uiKey="u-cde4ba9d77f6"> Xóa</UiCustomText></button>}</UiToolbar></td>
                </tr>
              })}</tbody>
            </table>
          </div>
