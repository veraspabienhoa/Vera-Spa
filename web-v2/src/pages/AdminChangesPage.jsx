...
export default function AdminChangesPage() {
  ...
  return <div className="feature-page">
    ...
    <section className="panel data-toolbar"><div className="audit-toolbar-content">
      ...
      <div className="audit-search-line"><EmployeeSelector label="Người thực hiện" employees={actors} value={actorSearch} onChange={(value) => { setActorSearch(value); setActor(value.trim()) }} /><div className="audit-total">{data.changes?.length || 0} thay đổi</div></div>
    </div></section>
