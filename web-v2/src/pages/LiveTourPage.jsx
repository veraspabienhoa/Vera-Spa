...
export default function LiveTourPage({ user, navigationToggle = null }) {
  ...
  return <div className="feature-page tour-page live-tour-page">
    <style>{`
      ...
      .live-tour-page .tour-room-panel{margin:0;padding:0;border:1px solid #cfe1d8;border-radius:4px;background:#f3faf6}.live-tour-page .tour-room-panel-head{display:flex;align-items:center;gap:6px;min-width:0;margin:0;padding:0;overflow-x:auto;overflow-y:hidden;overscroll-behavior-x:contain;scrollbar-width:thin}.live-tour-page .tour-room-panel-title{display:flex;flex:0 0 auto;align-items:center;gap:4px;color:#173c30;font-size:11px;font-weight:900;white-space:nowrap}.live-tour-page .tour-room-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(108px,1fr));gap:0 3px}
      ...
      @media(max-width:640px){
        ...
        .live-tour-page .tour-room-panel{padding:0}.live-tour-page .tour-room-panel-head{gap:4px;margin-bottom:0}.live-tour-page .tour-room-panel-title{font-size:9px}.live-tour-page .tour-room-grid{grid-template-columns:repeat(3,minmax(0,1fr));gap:0 3px}.live-tour-page .tour-room-card{min-height:46px;padding:2px}.live-tour-page .tour-room-card.vip{padding:0}.live-tour-page .tour-room-card-head strong{font-size:8px}.live-tour-page .tour-room-type{padding:0 2px;font-size:4px}.live-tour-page .tour-room-countdown{font-size:9px}.live-tour-page .tour-room-countdown svg{width:10px;height:10px}.live-tour-page .tour-room-meta{font-size:6px}.live-tour-page .tour-room-detail-row{grid-template-columns:minmax(75px,.55fr) minmax(0,1fr);gap:4px;padding:4px;font-size:7px}
      }
