...
export default function LiveTourPage({ user }) {
  ...
  return <div className="feature-page tour-page live-tour-page">
    <style>{`
      ...
      .live-tour-page .tour-control-layout{min-width:0}.live-tour-page .tour-control-layout .tour-metrics{grid-template-columns:repeat(8,minmax(120px,1fr));gap:4px;max-width:100%;padding:3px;overflow-x:auto;overflow-y:hidden;overscroll-behavior-x:contain;scrollbar-width:thin}.live-tour-page .metric-grid.small .metric-card.tour-metric-card{min-height:30px;gap:5px;border-radius:7px;padding:3px 6px}.live-tour-page .metric-grid.small .metric-card.tour-metric-card span{font-size:9px;white-space:nowrap}.live-tour-page .metric-grid.small .metric-card.tour-metric-card strong{font-size:15px}
      .live-tour-page .tour-room-segment-buttons{display:flex;flex:0 0 auto;align-items:center;gap:4px}.live-tour-page .tour-room-segment-button{flex:0 0 auto;min-width:0;min-height:30px;border:1px solid transparent;border-radius:7px;padding:4px 8px;display:flex;align-items:center;justify-content:center;gap:5px;color:#fff;font-weight:900;text-align:center;white-space:nowrap}.live-tour-page .tour-room-segment-button.all{background:linear-gradient(180deg,#426d5b,#294d3e);border-color:#244638}.live-tour-page .tour-room-segment-button.standard{background:#155b78;border-color:#0d465f}.live-tour-page .tour-room-segment-button.vip{background:linear-gradient(180deg,#bd9243,#92702f);border-color:#7d5c22}.live-tour-page .tour-room-segment-button svg{width:14px;height:14px;flex-shrink:0}.live-tour-page .tour-room-segment-button span{font-size:10px;line-height:1.1}.live-tour-page .tour-room-segment-button small{color:inherit;font-size:9px;opacity:.88}.live-tour-page .tour-room-segment-button.active{outline:2px solid rgba(23,51,41,.18);outline-offset:1px;box-shadow:0 5px 12px rgba(22,51,41,.17)}
      ...
      .live-tour-page .tour-room-panel{margin:0;padding:5px;border:1px solid #cfe1d8;border-radius:9px;background:#f3faf6}.live-tour-page .tour-room-panel-head{display:flex;align-items:center;gap:8px;min-width:0;margin-bottom:3px;padding:3px;overflow-x:auto;overflow-y:hidden;overscroll-behavior-x:contain;scrollbar-width:thin}.live-tour-page .tour-room-panel-title{display:flex;flex:0 0 auto;align-items:center;gap:4px;color:#173c30;font-size:11px;font-weight:900;white-space:nowrap}.live-tour-page .tour-room-panel-head>small{flex:0 0 auto;margin-left:auto;color:#3f574c;font-size:13px;font-weight:950;line-height:1;text-align:center;white-space:nowrap}.live-tour-page .tour-room-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(108px,1fr));gap:3px}
      ...
      @media(max-width:640px){
        ...
        .live-tour-page .tour-control-layout .tour-metrics{grid-template-columns:repeat(8,minmax(110px,1fr))}.live-tour-page .metric-grid.small .metric-card.tour-metric-card{min-height:31px;padding:3px 5px}.live-tour-page .metric-grid.small .metric-card.tour-metric-card span{font-size:8px;line-height:1.05}.live-tour-page .metric-grid.small .metric-card.tour-metric-card strong{font-size:14px}
        .live-tour-page .tour-room-segment-button{padding:4px 6px}.live-tour-page .tour-room-segment-button svg{width:12px;height:12px}.live-tour-page .tour-room-segment-button span{font-size:9px}.live-tour-page .tour-room-segment-button small{font-size:8px}
