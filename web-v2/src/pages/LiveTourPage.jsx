...
export default function LiveTourPage({ user, navigationToggle = null }) {
  ...
  return <div className="feature-page tour-page live-tour-page">
    <style>{`
      .live-tour-page{--live-tour-section-gap:6px;gap:var(--live-tour-section-gap)}.page-wrap.live-tour-page-wrap{padding-top:0;padding-bottom:0}.live-tour-page>.setup-note{padding:6px 9px;font-size:9px}
      ...
      .live-tour-page .tour-room-panel{margin:0;padding:0;border:1px solid #cfe1d8;border-radius:4px;background:#f3faf6}.live-tour-page .tour-room-panel-head{display:flex;align-items:center;gap:6px;min-width:0;margin:0;padding:0;overflow-x:auto;overflow-y:hidden;overscroll-behavior-x:contain;scrollbar-width:thin}.live-tour-page .tour-room-panel-title{display:flex;flex:0 0 auto;align-items:center;gap:4px;color:#173c30;font-size:11px;font-weight:900;white-space:nowrap}.live-tour-page .tour-room-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(108px,1fr));gap:var(--live-tour-section-gap) 3px}
      ...
      @media(max-width:640px){
        .live-tour-page{--live-tour-section-gap:8px}
