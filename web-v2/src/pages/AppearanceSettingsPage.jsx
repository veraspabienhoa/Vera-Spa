...
export default function AppearanceSettingsPage({ user, section, onDirtyChange }) {
  usePageRefresh(() => load(), () => Boolean(busy || saving || JSON.stringify(draft) !== JSON.stringify(defaultDraft)))
  ...
  useEffect(() => { onDirtyChange?.(JSON.stringify(draft) !== JSON.stringify(defaultDraft)) }, [draft, defaultDraft, onDirtyChange])
