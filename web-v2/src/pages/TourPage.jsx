...
export default function TourPage({ user }) {
  ...
  const metrics = [
    ['Số nhân viên', data.employee_count ?? data.count ?? 0, ''],
    ['Có thể lên tua', data.available || 0, 'tour-available-metric'],
    ['Đi làm', data.working_count || 0, ''],
    ['Nghỉ giữa Ca', data.break_count || 0, 'tour-break-metric'],
    ['Nghỉ phép', data.leave_count || 0, ''],
    ['Đang thực hiện', data.doing_count || 0, ''],
    ['Đang chờ', data.waiting_count || 0, ''],
    ['Sắp xong', data.finishing_count || 0, ''],
  ]
