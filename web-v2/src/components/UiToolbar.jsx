...
export default forwardRef(function UiToolbar({ children, ...props }, forwardedRef) {
  ...
  return <div {...props} ref={ref}>
    {config.mode === 'group' && canGroup && !editing && nodes.length>3 ? <>{nodes.slice(0,2)}<details className="ui-more-actions"><summary>Thao tác khác</summary><div>{nodes.slice(2)}</div></details></> : nodes}
  </div>
})
