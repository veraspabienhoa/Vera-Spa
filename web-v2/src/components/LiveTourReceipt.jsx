...
export default function LiveTourReceipt({ invoice, autoPrint, onClose }) {
  ...
  return createPortal(<div id="live-tour-receipt" className="tour-receipt-backdrop"><section data-ui-key="u-b73a7691cb58" ref={dialogRef} tabIndex="-1" className="tour-receipt" role="dialog" aria-modal="true" aria-label={`Hóa đơn ${receiptNumber(invoice.bill_no)}`}>
    <UiToolbar data-ui-key="u-6498b3ba6cbd" className="tour-receipt-actions"><button data-ui-key="u-cc86ad71445c" data-ui-label-default="In hóa đơn" className="primary-button" onClick={printReceipt}><Printer size={16}/><UiCustomText uiKey="u-cc86ad71445c"> In hóa đơn</UiCustomText></button><button data-ui-key="u-ba558dd6ab8a" data-ui-label-default="Đóng" className="secondary-button" onClick={onClose}><X size={16}/><UiCustomText uiKey="u-ba558dd6ab8a"> Đóng</UiCustomText></button></UiToolbar>
