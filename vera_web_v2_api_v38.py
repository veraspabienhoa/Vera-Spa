...
install_live_tour_routes(_shared.app, engine_instance=_api._engine_instance, current_identity=_api.current_identity, require_feature=_api._require_feature, feature_allowed=_api._feature_allowed, identity_type=_api.Identity, vn_tz=_api.VN_TZ, google_client=_api._google_client, leave_sheet_id=_api.LEAVE_SHEET_ID, invalidate_tour_cache=invalidate_tour_cache)
