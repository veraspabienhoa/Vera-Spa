...
from vera_web_v2_runtime_env import load_managed_runtime_environment, load_live_tour_mode_override
...
from vera_web_v2_hr import install_hr_routes
...
from vera_web_v2_payroll_live_tour_tip import install_payroll_live_tour_tip_routes
...
install_hr_routes(_shared.app, engine_instance=_api._engine_instance, current_identity=_api.current_identity, identity_type=_api.Identity)
...
install_payroll_live_tour_tip_routes(_shared.app, engine_instance=_api._engine_instance, current_identity=_api.current_identity, require_feature=_api._require_feature, identity_type=_api.Identity)
