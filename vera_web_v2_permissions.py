...
FEATURE_GROUPS: dict[str, dict[str, str]] = {
    ...
    "Live Tour": {
        ...
        "live_tour_export": "Xuất Excel / Chụp hình bảng tua",
        "live_tour_invoice_date_edit": "Sửa ngày giờ hóa đơn (cần quyền sửa hóa đơn)",
        "live_tour_customers_edit": "Sửa hồ sơ khách hàng",
