...
- Workflow Lễ tân được chạy khi sửa trang Đăng ký nghỉ: cập nhật cách đọc năm nhóm từ cấu hình mặc định, vị trí bảng chính sách trong Nội quy và kiểm thử Quản lý theo cùng giới hạn ngày/nhóm với Lễ tân. Năm bài kiểm thử Node và các bước guard đạt; không thay đổi chính sách phân quyền.
